    ...
    namespace Landing
    {
        public class CourseCorrection : AutopilotStep
        {
            ...
            public override AutopilotStep Drive(FlightCtrlState s)
            {
                ...
                // 150 works ok for non atmospheric bodies, but need looser threshold for atmospheric planets, otherwise never seem to go under threshold for some planets.
                // TODO: Another issue causing issues is the predicted location appears to show a stronger deceleration profile that what needs to happen, mainly an issue at low orbits.
                if (currentError < (MainBody.atmosphere ? 1200 : 150) )
                {
                ...
                Vector3d deltaV = Core.Landing.ComputeCourseCorrection(); // Default is to allow prograde correction.
