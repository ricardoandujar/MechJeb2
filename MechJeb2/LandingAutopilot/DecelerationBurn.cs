        ...
        public class DecelerationBurn : AutopilotStep
        {
            ...
            public override AutopilotStep OnFixedUpdate()
            {
                ...
                if (decelerationStartTime - VesselState.time > 5 && !_decelerationBurnTriggered)
                {
                    ...
                    bool warpReady = Core.Attitude.attitudeAngleFromTarget() < 5 && (Vector3.Scale(Core.vessel.angularVelocity, new Vector3(1f, 0f, 1f)).magnitude < 0.001);
                ...
                Vector3d courseCorrection = Core.Landing.ComputeCourseCorrection(0,0); // Do not allow prograde correction.
